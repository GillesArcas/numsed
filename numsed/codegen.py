"""
    ...
    https://github.com/CensoredUsername/codegen
"""
...
class SourceGenerator(NodeVisitor):
    ...
    def visit_Print(self, node):
        ...
        # if no argument, values[0] is Tuple(elts=[], ctx=Load())
        if not (isinstance(node.values[0], Tuple) and node.values[0].elts == []):
